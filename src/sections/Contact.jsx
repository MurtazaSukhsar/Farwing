...
export default function Contact() {
  ...
  const inputClasses = (field) => `
    ...
    ${focusedField === field 
      ...
      : 'border-farwing-border hover:border-blue-500/30'
    }
  `;
  ...
  return (
    <section id="contact" className="relative py-32 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-blue-500/5 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="glass-card p-6 group hover:border-blue-500/30 transition-colors">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a 
                    href="mailto:farwingsolutions@gmail.com" 
            ...
            <div className="glass-card p-6 group hover:border-blue-500/30 transition-colors">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-farwing-muted text-sm">Available for consultation</p>
                </div>
              </div>
            </div>
          ...
          >
            <form onSubmit={handleSubmit} className="glass-card p-8 relative overflow-hidden">
              {/* Glow Effect */}
              <div className="absolute -inset-px bg-gradient-to-r from-blue-500/0 via-blue-500/10 to-cyan-500/0 rounded-2xl blur-xl opacity-0 hover:opacity-100 transition-opacity" />
              ...
              <div className="relative z-10 space-y-6">
                ...
                <motion.button
                  ...
                  className="w-full py-4 bg-gradient-to-r from-blue-600 to-blue-500 text-white font-semibold rounded-xl flex items-center justify-center gap-2 relative overflow-hidden group disabled:opacity-70"
